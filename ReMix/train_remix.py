...
def main():
    ...
    parser.add_argument('--dataset', default='Camelyon16', type=str,
                        choices=['Camelyon16', 'Unitopatho', 'C16_dataset_c16_low99_v0'], help='Dataset folder name')
    ...
    assert args.dataset in ['Camelyon16', 'Unitopatho', 'C16_dataset_c16_low99_v0'], 'Dataset not supported'
    ...
    args.num_classes = {'Camelyon16': 1, 'Unitopatho': 6, 'C16_dataset_c16_low99_v0': 1}[args.dataset]
